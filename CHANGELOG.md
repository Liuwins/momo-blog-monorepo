...
- 后端升级至 NestJS 11（含 Config、JWT、Passport、TypeORM、WebSockets、CLI 和 Schematics）；后端 32 条测试、typecheck/build、官方 npm 生产依赖审计、隔离 Compose 和 GitHub Actions（运行 `32506810694`）验证通过，真实服务器仍需验收。
